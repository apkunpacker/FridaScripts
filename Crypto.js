...
function stringToBytes(str) {
 ...
 //The method of converting byte[] into String
...
Java.perform(function () {
    ...
    secretKeySpec.$init.overload('[B', 'java.lang.String').implementation = function (a, b) {
       // showStacks();
        ...
        console.log("======================================");
                 console.log("Algorithm name:" + b + "|str key:" + bytesToString(a));
                 console.log("Algorithm name:" + b + "|Hex key:" + bytesToHex(a));
        return result;
    }
    ...
    mac.doFinal.overload().implementation = function () {
        ...
        console.log("======================================");
                 console.log("doFinal result:  |str :" + bytesToString(result));
                 console.log("doFinal result:  |hex :" + bytesToHex(result));
                 console.log("doFinal result:  |base64 :" + bytesToBase64(result));
        return result;
    }
    mac.doFinal.overload('[B').implementation = function (a) {
        ...
        console.log("======================================");
                 console.log("doFinal parameter: |str :" + bytesToString(a));
                 console.log("doFinal result:  |str :" + bytesToString(result));
                 console.log("doFinal result:  |hex :" + bytesToHex(result));
                 console.log("doFinal result:  |base64 :" + bytesToBase64(result));
        return result;
    ...
    md.digest.overload('[B').implementation = function (a) {
        //showStacks();
        console.log("======================================");
                 console.log("digest parameter:" + bytesToString(a));
    ...
    ivParameterSpec.$init.overload('[B').implementation = function (a) {
        ...
        var result = this.$init(a);
        console.log("======================================");
                 console.log("iv vector: |str:" + bytesToString(a));
        console.log("iv vector: |hex:" + bytesToHex(a));
        return result;
    }
    ...
    cipher.init.overload('int', 'java.security.Key').implementation = function (a, b) {
        ...
        if (N_ENCRYPT_MODE == a) 
        {
                         console.log("init | encryption mode");    
        }
        else if(N_DECRYPT_MODE == a)
        {
                         console.log("init | Decryption Mode");    
        }

        var bytes_key = b.getEncoded();
                 console.log("init key:" + "|str key:" + bytesToString(bytes_key));
                 console.log("init key:" + "|Hex key:" + bytesToHex(bytes_key));
        return result;
    }
    ...
    cipher.doFinal.overload('[B').implementation = function (a) {
        ...
        var result = this.doFinal(a);
        console.log("======================================");
        console.log ("DOFINAL Parameters: | STR:" + bytesToString (a));
                 console.log ("DOFINAL Results: | STR:" + bytesToString (result));
                 console.log ("DOFINAL Results: | HEX:" + bytesToHex (result));
                 console.log ("DOFINAL Results: | Base64:" + bytesToBase64 (result));
        return result;
    }
    ...
    x509EncodedKeySpec.$init.overload('[B').implementation = function (a) {
        ...
        var result = this.$init(a);
        console.log("======================================");
                 console.log ("RSA Key: " + bytesToBase64 (a));
        return result;
    }
    ...
    rSAPublicKeySpec.$init.overload('java.math.BigInteger', 'java.math.BigInteger').implementation = function (a, b) {
        ...
        console.log("======================================");
                 //CONSOLE.LOG ("RSA Key: "+ bytestobase64 (a));
                 console.log ("RSA Key N:" + A.TOString (16));
                 console.log ("RSA Key E:" + B.toString (16));
        return result;
    }
    ...
    KeyPairGenerator.generateKeyPair.implementation = function () 
    {
        ...
        var str_public = result.getPublic().getEncoded();
                 console.log ("Public Key | HEX" + BytestoHex (STR_PUBLIC));
                 console.log ("Private Key | HEX" + BytestoHex (STR_PRIVATE));
